# -*- coding: utf-8 -*-
"""
Created on Wed Nov 10 19:04:52 2021
...
st.title("K-Means figures")

d = st.slider("Choose iteration times", min_value = 1, max_value = 20,value=1)
...
kmeans = KMeans(n_clusters = 5, max_iter=d, init=starting_points, n_init = 1)
kmeans.fit(X);
